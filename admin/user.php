...
if (!$_SESSION['loggedIn']) {
 ...
 if((isset($_GET['Id']))  && isset($_GET['type']))
 {
...

    {
        ...
        $Id = $_GET['Id'];
         ...
         $Usql = " UPDATE `user` SET `status`='$status' WHERE `id` = $Id";
 ...
 $editName = $_POST['editcategoryName'];
   $editnum =  $_POST['editorderNumber'];
   echo  $sno = $_POST['sno'];
    
    $usql = "UPDATE `user` SET `name` = '$editName', `mobile` = '$editnum' WHERE `id` = $sno";

  $result = mysqli_query($connection,$usql);
  if($result){
    $msg='<strong class="text-success">Success! User detail Updated!</strong>'; 
    $alert = true;
...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="user.php" method="post">
                        ...
                        <div class="my-3 ">
                            <label for="categoryName" class="form-label">User Name</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="editorderNumber" id="editorderNumber"
                                required>
    ...
    <div class="container bg-gray col-12 col-md-9 d-inline-block float-right mx-2 mt-5">
        <h4 class="effect">User master</h4>

        <a type="button" href="addUser.php" class="btn btn-outline-dark border border-dark rounded-pill my-3  p-3">Add a  Users</a>
        <?php 
if($alert){
        ...
        <table class="table table-striped mt-3 border" id="myTable">
            <thead class="table-light ">
                ...
                <tr>
                    ...
                    <th scope="col" width="12%">Mobile</th>
